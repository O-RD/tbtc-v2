    ...
    Initializable
{
    ...
    function initialize(
        ...
        //
        // Authorization decrease delay is 45 days. * But I changed it to 10
        //
        ...
        authorization.setAuthorizationDecreaseDelay(10);
        authorization.setAuthorizationDecreaseChangePeriod(10);
        ...
        dkg.setSeedTimeout(40);
        dkg.setResultChallengePeriodLength(11);
        dkg.setResultChallengeExtraGas(50_000);
        dkg.setResultSubmissionTimeout(180);
